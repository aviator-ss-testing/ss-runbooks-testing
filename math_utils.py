...
This module provides pure functions for mathematical calculations including
factorial, fibonacci, prime checking, GCD, and LCM operations.
"""
...
def lcm(a: int, b: int) -> int:
    ...
    if a == 0 and b == 0:
        raise ValueError("lcm(0, 0) is not defined")
